...
PATH_TO_EMBEDDINGS =  "filtered_test_preds_final_nouns_only_embeddings.pickle"
PATH_TO_FILE = "../get-context/filtered_set_test_articles_tokenized_context_latest_with_context.json"
NUM_OF_PRED = 20
NUM_CLUSTERS = 5 
PATH_TO_FILE_OUT = "k_means_test_set_filtered_latest_new.json".format(NUM_OF_PRED)
